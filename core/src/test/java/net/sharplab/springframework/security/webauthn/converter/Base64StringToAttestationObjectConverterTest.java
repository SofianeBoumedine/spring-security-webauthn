...
public class Base64StringToAttestationObjectConverterTest {
    ...
    public void convert_test() {
        ...
        String source = new AttestationObjectConverter(objectMapper).convertToString(expected);
        Base64StringToAttestationObjectConverter converter = new Base64StringToAttestationObjectConverter(objectMapper);
